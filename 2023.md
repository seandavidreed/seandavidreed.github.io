...
### 9/12/2023
#### Accelerated CS Fundamentals
Continued in the second course, Ordered Data Structures, of this specialization. I spent the most time on a video about Run-Time Analysis. To explain run-time analysis, the lecturer contrasted two data structures, the Array and the Linked List.